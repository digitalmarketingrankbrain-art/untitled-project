      ...
      <div className="bg-[#0b2341] text-white py-12 border-b border-blue-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 text-center">
          <nav className="mb-4 flex items-center justify-center gap-2 text-xs text-slate-300 font-medium">
            ...
            <span className="text-amber-400 font-semibold">Information Center</span>
          </nav>
          <h1 className="text-3xl font-extrabold tracking-tight text-white sm:text-5xl">UASL Information Center</h1>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-10 shadow-md space-y-4 text-slate-700">
          <p className="text-sm leading-relaxed">
            Welcome to the UASL Information Center. Access policy publications, technical guidance notes, standards updates, and official bulletins.
          </p>
        </div>
      </div>
    </div>
