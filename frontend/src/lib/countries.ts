/** ISO 3166-1 country list (code + common name), used by the CAB Info Applied/Approved Countries picker. */
...
export const COUNTRIES: Country[] = [
  ...
  { code: "BS", name: "The Bahamas" }, { code: "BH", name: "Bahrain" }, { code: "BD", name: "Bangladesh" },
  ...
  { code: "GR", name: "Greece" }, { code: "GD", name: "Grenada" }, { code: "GU", name: "Guam" },
  ...
  { code: "VN", name: "Vietnam" }, { code: "VG", name: "Virgin Islands (British)" }, { code: "VI", name: "Virgin Islands (US)" },
